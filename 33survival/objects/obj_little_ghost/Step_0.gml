...
//如果玩家进入攻击范围，且子弹冷却完毕。
if collision_circle(x, y, 150, oPlayer, false, true) and attack_loading = 0 {

	xx = 1.5;
	attack_loading = 300;
	var _bullet_enemy = instance_create_layer(x, y, "Instances", obj_bullet_enemy);
	_bullet_enemy.bullet_hp = 240;//子弹存在时间。
	_bullet_enemy.bullet_damage = bullet_damage;//子弹伤害。
	_bullet_enemy.speed = 1.5;//子弹速度。
