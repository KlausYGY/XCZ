...
draw_text_transformed_color(x - 26, y - 2, "多重散射", 0.6, 0.6, 0,  c_white,  c_white,  c_white,  c_white, image_alpha);

draw_text_transformed_color(x - 4 , y + 30 + (xx_lock * 8), level, 1, 1, 0,  c_white,  c_white,  c_white,  c_white, image_alpha);

if global.exp_red >= (level * 20) {
...
if random_up_text_mode = 1 {
	draw_text_transformed_color(x - 26, y + 60, "! 多重散射提升 !", 0.6, 0.6, 0,  c_white,  c_white,  c_white,  c_white, image_alpha);
	draw_text_transformed_color(x - 26, y + 80, "多重散射 + "  + string( random_up_text_darw ), 0.4, 0.4, 0,  c_white,  c_white,  c_white,  c_white, image_alpha);
}